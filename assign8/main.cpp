...
bool debug = false;
// if debug = true, then program waits after each clock cycle for a keypress
// if false, everything prints at once
bool syntax_input = true;
// if syntax_input = true, then read mips syntax instructions (like add $5, $4, $3) 
// from input_instructions_path (see global.cpp)
// if false, then read 32-bit binary instructions from binary_input_path (in global.cpp)
